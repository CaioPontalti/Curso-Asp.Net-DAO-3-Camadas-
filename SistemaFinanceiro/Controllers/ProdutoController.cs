...
namespace SistemaFinanceiro.Controllers
{
    public class ProdutoController : Controller
    {
        ...
        private void PopularComboCategoria()
        {
            ...
            List<Categoria> data = objCategoriaNeg.findAll();//Lista de categorias

                                             //1º Parametro: Lista com as categorias
                                             //2º Id que será gravado no IdCategoria do Produto
                                             //3º Texto que vai aparacer no DropDown
        ...
        public ActionResult BuscarProdutos(string txtproduto, string txtnome, string ListaCategorias)
        {
            ...
            if (txtnome != "-1" || txtproduto != "-1" || ListaCategorias != "-1")
            {
                ...
                produto = objProdutoNeg.findAllProdutos(objProduto);
            }
            else
            {
                produto = objProdutoNeg.findAll();
            }    
